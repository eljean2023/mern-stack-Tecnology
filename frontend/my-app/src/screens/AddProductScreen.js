...
import {productAddAction} from '../actions/produtcAction'
...
const addProduct = useSelector(state=>state.productAdd)
const{loading, error, productInfo} = addProduct
...
const onSubmitHandler = (e) =>{
    e.preventDefault()
        ...
        dispatch(productAddAction(name, link/* title, category,price, filename */))
          navigate('/profile')
} 
  ...
  return (
    ...
    <FormContainer>
        <h2 className='titles animate__animated animate__bounceIn animate__delay-1s	3s'>Add your Video </h2>
