...
const RoomScreen = (props) => {
    ...
    const {id} = useParams()
    const {ws, me, stream,setStream, ShareScreen, screenSharingId,roomId,userNamex,userInvited, status, status2, setStatus, statusSpecial, statusSpecial2} = useContext(RoomContext)
